...
public class UNICODE_MessageBoxPanel extends JPanel
{
    ...
    {		
		...
		//establish menu panel
		menuPanel = new UNICODE_MessageBoxMenuPanelII ( generatedCustomComponentListII ( ), true, 340 + boxWidthGrowth - 100, -20, 2, 33, 1340 + axisRadiusDisplacement, "clockwise", "horizontal", buttonTextureDir, buttonWidth, buttonHeight, backgroundColour, buttonOutlineColour, buttonShapeType, arcHeight, arcDepth, lastButtonChopValue );
		menuPanel.setPreferredSize ( new java.awt.Dimension ( getWidth ( ), 100 ) );
	...
	//constructor : customizable one threaded frame....one button, one thread, label, and a display View Panel
	//but the okay button does not quit the box
    public UNICODE_MessageBoxPanel ( Thread _thread0, String labelText, Color backgroundColour, Color buttonOutlineColour, Color labelBackgroundColour, Color labelForegroundColour, Color fieldLabelForegroundColour, JFrame _messageBoxWindowFrame, String buttonTextureDir, String buttonShapeType, int buttonWidth, int buttonHeight, int arcHeight, int arcDepth, int axisRadiusDisplacement, int lastButtonChopValue, int maxFields, Color textfieldBackgroundColour, Color textfieldForegroundColour, int fieldWidth, int fieldHeight, int boxWidthGrowth, ArrayList <String> fieldLabelList, String prebakedAreaText, Color textAreaBackgroundColour, Color textAreaForegroundColour )
    {		
		//establish thread
		thread0 = _thread0;
		...
		javax.swing.JScrollPane textAreaScrollPane = new javax.swing.JScrollPane ( );
		textAreaScrollPane.add ( textArea );
		textAreaScrollPane.setPreferredSize ( new java.awt.Dimension ( 320, 200 ) );
		...
		//establish menu panel
		menuPanel = new UNICODE_MessageBoxMenuPanelII ( generatedCustomComponentListII ( ), true, 340 + boxWidthGrowth - 100, -30, 2, 33, 1340 + axisRadiusDisplacement, "clockwise", "horizontal", buttonTextureDir, buttonWidth, buttonHeight, backgroundColour, buttonOutlineColour, buttonShapeType, arcHeight, arcDepth, lastButtonChopValue );
		menuPanel.setPreferredSize ( new java.awt.Dimension ( getWidth ( ), 100 ) );
		...
		fieldListPanel.add ( textAreaScrollPane );
